...
// Allowed characters in URL-safe Base62 encoding
// a-z A-Z 0-9_.-~
...
// Confurigable values of the service
// Port to listen to
// The schema for the short links
//  Domain for the short links
// DB connections parameters
// For simplicity will be storing everything in Json format